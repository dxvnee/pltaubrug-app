...
import org.d3if3121.pltaconnect.ui.component.InputPassword
...
fun RegisterPage(
    ...
    var addingPegawai by remember { mutableStateOf(false) }
    ...
    when(val addPegawai = viewmodel.addPegawaiResponse) {
        is Loading -> {
        }
        is Success -> {
        ...
        is Failure -> {
            errorMessage = addPegawai.e!!.message.toString()
            printError(addPegawai.e)
            Log.d("tes", "masukkkkk")
        }
    }
