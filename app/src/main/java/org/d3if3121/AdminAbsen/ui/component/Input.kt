...
fun InputPutih(
    ...
    OutlinedTextField(
        ...
        colors = TextFieldDefaults.colors(
            ...
            focusedPlaceholderColor = Warna.Biru,
            focusedIndicatorColor = Warna.Biru,
...
fun InputPutihSearchProfile(
    ...
    Card(
        modifier = modifier
            .border(1.dp, if (!isFocused) Warna.AbuMuda else Warna.Biru, RoundedCornerShape(10.dp)).fillMaxHeight(),
