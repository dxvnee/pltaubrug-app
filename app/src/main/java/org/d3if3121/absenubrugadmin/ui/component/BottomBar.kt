...
import org.d3if3121.absenubrugadmin.navigation.BottomBarScreen
...
@Composable
fun BottomBar(navController: NavHostController, home: Boolean = false, homeAction: () -> Unit = {}, mahasiswaListViewModel: MahasiswaListViewModel = hiltViewModel()){
    val screens = listOf(
    ...
    BottomNavigation(
        ...
        screens.forEach{ screen ->
            AddItem(screen = screen, currentDestination = currentDestination, navController = navController, home, homeAction, mahasiswaListViewModel)
        }
    }
...
fun RowScope.AddItem(
    ...
    home: Boolean = false,
    homeAction: () -> Unit,
    mahasiswaListViewModel: MahasiswaListViewModel = hiltViewModel()
){
